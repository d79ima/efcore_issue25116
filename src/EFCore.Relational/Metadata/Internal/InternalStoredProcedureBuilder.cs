    ...
    IConventionStoredProcedureBuilder
{
    ...
    {
        var sproc = StoredProcedure.GetStoredProcedure(entityType, sprocType);
        if (sproc == null)
        {
            sproc = StoredProcedure.SetStoredProcedure(entityType, sprocType);
        }
        else
        {
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public virtual InternalStoredProcedureBuilder? WithNewParameterOrder(ConfigurationSource configurationSource)
    {
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public virtual InternalStoredProcedureBuilder? WithNewResultColumnOrder(ConfigurationSource configurationSource)
    {
        if (!configurationSource.Overrides(Metadata.GetConfigurationSource()))
        {
            return null;
    ...
    /// <inheritdoc />
    [DebuggerStepThrough]
    IConventionStoredProcedureBuilder? IConventionStoredProcedureBuilder.WithNewParameterOrder(bool fromDataAnnotation)
        => WithNewParameterOrder(fromDataAnnotation ? ConfigurationSource.DataAnnotation : ConfigurationSource.Convention);
    ...
    /// <inheritdoc />
    [DebuggerStepThrough]
    IConventionStoredProcedureBuilder? IConventionStoredProcedureBuilder.WithNewResultColumnOrder(bool fromDataAnnotation)
        => WithNewResultColumnOrder(fromDataAnnotation ? ConfigurationSource.DataAnnotation : ConfigurationSource.Convention);
}
